...
let sliderExpress;
let allSlides = document.querySelector('.counter-slider-express__total');
let allCurrentSlide = document.querySelector('.counter-slider-express__current');
const allSlidesCounter = document.querySelectorAll('.slider-express__slide').length;

sliderExpress = new Swiper('.slider-express__body', {
	// slider-express__slider
	// wrapperClass: "slider-express__body",
	// slideClass: "slider-express__slide",
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 0,
...
bestBottomBody = new Swiper('.best-bottom__slider', {
	// best-bottom__slider
	wrapperClass: "best-bottom__body",
	slideClass: "best-bottom__slide",
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 0,
	...
	// Dotts
	pagination: {
		el: '.best-bottom__dots',
		clickable: true,
	},
	// Arrows
	navigation: {
		nextEl: '.best-bottom__arrow--left',
		prevEl: '.best-bottom__arrow--right',
	},
	// breakpoints: {
	// 	320: {
	// 		loopedSlides: 2,
...
//  new menu
let newsIcon = document.querySelector(".news-navigation__icon");
if (newsIcon != null) {
	let delay = 500;
	let iconBox = document.querySelector(".news-navigation__icon-box");
	let menuScecondBody = document.querySelector(".news-navigation__drop-down");
	newsIcon.addEventListener("click", function (e) {
		if (unlock) {
			// body_lock(delay);
			newsIcon.classList.toggle("_active");
			menuScecondBody.classList.toggle("_active");
			iconBox.classList.toggle("_active");
		}
	});
};
function menu_close() {
	let newsIcon = document.querySelector(".news-navigation__drop-down");
	let menuScecondBody = document.querySelector(".news-navigation__drop-down");
	let iconBox = document.querySelector(".news-navigation__icon-box");
	newsIcon.classList.remove("_active");
	menuScecondBody.classList.remove("_active");
	iconBox.classList.remove("_active");
}
//=================
//BodyLock
...
Для заголовков слойлеров пишем атрибут 
